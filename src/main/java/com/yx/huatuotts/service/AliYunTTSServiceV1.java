 ...
 */
@Service
public class AliYunTTSServiceV1 {
    ...
    public FlowingSpeechSynthesizer synthesizeAudio(SseEmitter emitter, TtsParam ttsParam) {
...
//                            logger.info("tts first latency : " + (now - AliYunTTSService.startTime) +
//                                    " ms");
                        }
...
//                        emitter.send(bytesArray);
                        ...
                        logger.info("write array:" + bytesArray.length);
